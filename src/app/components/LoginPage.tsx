                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/40 p-10 vibrant-glow relative overflow-hidden">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-11 pr-4 py-3.5 bg-white/50 border border-gray-200 rounded-2xl focus:ring-4 focus:ring-violet-500/10 focus:border-violet-500 outline-none transition-all"
                        ...
                        <div className="flex items-center justify-between px-1">
                            ...
                            <div className="text-sm">
                                <a href="#" className="font-semibold text-violet-600 hover:text-violet-500 transition-colors">
                                    Forgot password?
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="mt-10 text-center">
                        <p className="text-sm text-gray-500">
                            Powered by <span className="font-bold text-violet-600">Nocastra</span>
                        </p>
                    </div>
                </div>
            </div>
