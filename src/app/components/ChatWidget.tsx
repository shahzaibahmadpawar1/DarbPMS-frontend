...
const roles = [
    ...
    { id: "engineer", name: "Engineer", color: "bg-purple-500", online: false },
...
export function ChatWidget({ isOpen, onClose }: ChatWidgetProps) {
    ...
    return (
        ...
        >
            {/* Header */}
            <div className="bg-gradient-to-r from-violet-600 to-cyan-500 rounded-t-2xl p-4 flex items-center justify-between">
                            ...
                            >
                                ...
                                >
                                    {!message.isCurrentUser && (
                                        <p className="text-xs font-semibold mb-1 text-violet-600">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-200 rounded-b-2xl">
                        <div className="flex items-end gap-2">
                            <textarea
                                ...
                                className="flex-1 resize-none border border-gray-300 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent max-h-24"
                                rows={1}
                            />
                            <button
                                onClick={handleSendMessage}
                                disabled={!newMessage.trim()}
                                className="w-10 h-10 bg-gradient-to-r from-violet-600 to-cyan-500 rounded-xl flex items-center justify-center hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
