    ...
    <div className="p-8">
      <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Manage commercial licensing and compliance certificates</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-card rounded-xl shadow-xl p-8 card-glow border-t-4 border-primary relative overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">
                  License Number (PK) <span className="text-error">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Payment Due Date</label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Issuance Date</label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Number of Days (Calculated)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">License Status</label>
                <select
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Owner ID</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">ISIC Classification</label>
                <input
                  type="text"
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Municipality</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Sub-Municipality</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Total Space (sqm)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Signage Space (sqm)</label>
                <input
                  type="number"
