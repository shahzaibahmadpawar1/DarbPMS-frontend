...
export function TaqyeesLicenseForm() {
  ...
  const [formData, setFormData] = useState({
    licenseNumber: isReadOnly ? "TAQ-2024-55109" : "",
    issuanceDate: isReadOnly ? "2024-03-01" : "",
    expiryDate: isReadOnly ? "2025-03-01" : "",
  ...
  return (
    <div className="p-8">
      ...
      {viewMode === 'form' ? (
        <form onSubmit={(e) => { e.preventDefault(); alert("Taqyees License saved!"); }} className="bg-card rounded-xl shadow-xl p-8 card-glow border-t-4 border-primary relative overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
