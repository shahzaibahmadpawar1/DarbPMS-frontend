  ...
  return (
    <div className="p-8">
      <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Building Permit (Municipality)</h1>
          <p className="text-muted-foreground mt-2">Manage municipal construction and building permits</p>
        </div>
      ...
      {viewMode === 'form' ? (
        <form onSubmit={(e) => { e.preventDefault(); alert("Building Permit saved!"); }} className="bg-card rounded-xl shadow-xl p-8 card-glow border-t-4 border-primary relative overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
