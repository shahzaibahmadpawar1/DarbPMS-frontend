...
export function SalamahLicenseForm() {
  ...
  return (
    <div className="p-8">
      ...
      {viewMode === 'form' ? (
        <form onSubmit={(e) => { e.preventDefault(); alert("Salamah License saved!"); }} className="bg-white rounded-lg shadow-md p-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
