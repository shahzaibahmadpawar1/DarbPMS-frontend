        ...
        <form onSubmit={handleSubmit} className="bg-card rounded-xl shadow-xl p-8 card-glow border-t-4 border-primary relative overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Signature Date</label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Signature Location</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Tenancy Start Date</label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Tenancy End Date</label>
                <input
                  type="date"
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Lessor Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Lessor Nationality</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Lessor ID Type</label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Lessor ID No</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Lessor Mobile</label>
                <input
                  type="tel"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Lessor Email</label>
                <input
                  type="email"
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Tenant Nationality</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Tenant ID No</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Tenant Mobile</label>
                <input
                  type="tel"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Tenant Email</label>
                <input
                  type="email"
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Duration (Years)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Contract Value (SAR)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Number of Installments</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Due Amount (SAR)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Paid Amount (SAR)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Unpaid Amount (SAR)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-muted-foreground mb-1">Due Period</label>
                <input
                  type="text"
