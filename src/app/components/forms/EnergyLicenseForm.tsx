...
export function EnergyLicenseForm() {
  ...
  return (
    <div className="p-8">
      ...
      {viewMode === 'form' ? (
        <form onSubmit={(e) => { e.preventDefault(); alert("Energy License saved!"); }} className="bg-card rounded-xl shadow-xl p-8 card-glow border-t-4 border-primary relative overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
