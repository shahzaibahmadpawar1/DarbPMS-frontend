            ...
            <div className="flex items-center justify-between mb-6">
                <div className="relative flex-1 max-w-md">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-[#ff6b35]"
                    />
                </div>
                                ...
                                <tr key={rIdx} className="hover:bg-gray-50 transition-colors group">
                                        ...
                                        <td key={vIdx} className="px-6 py-4">
                                            {vIdx === 0 ? (
                                                <div className="flex items-center gap-3">
                                                    <div className="p-2 bg-orange-50 rounded text-[#ff6b35]">
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <button className="p-2 text-gray-400 hover:text-[#ff6b35] hover:bg-orange-50 rounded-lg">
